...
# --- Load houses data (descriptions, colors, emojis, etc.) ---
...
def meet_friend(character):
    """
    Handles the Hogwarts Express sequence.
    The player meets several characters and their choices
...
def welcome_message():
    ...
    The player advances manually through each paragraph.
    """
...
def sorting_ceremony(character,questions):
    """
    ...
    slow_print(
        f"The Sorting Hat exclaims: {house}!\n"
...
def enter_common_room(character):
    ...
    slow_print(
        f"You follow the prefects through the castle corridors...\n\n"
...
def start_chapter_2(character):
    """
    Main orchestration function for Chapter 2.
    """
